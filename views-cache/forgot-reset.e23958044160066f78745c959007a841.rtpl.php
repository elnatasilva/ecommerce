...
<div class="lockscreen-wrapper">
  ...
  <!-- User name -->
  <div class="lockscreen-name h3"><?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?> - Alteração de Senha</div>
  ...
  <br>
    ...
    <form class=" form-inline" action="/admin/forgot/reset" method="post">
